# Generated by Powerlevel10k configuration wizard on 2020-01-03 at 22:00 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 24353.
# Wizard options: nerdfont-complete + powerline, large icons, rainbow, time,
# vertical separators, round heads, round tails, 2 lines, disconnected, full frame,
# light, compact, many icons, concise, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=178
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING='🧰 VI'
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=2
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING='🔦 VI'
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=4
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=3
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING='✏️  VI'
  ...
  ###############[ jenv: java version from jenv (https://github.com/jenv/jenv) ]################
  # Java color.
  typeset -g POWERLEVEL9K_JENV_FOREGROUND=2
  typeset -g POWERLEVEL9K_JENV_BACKGROUND=238
...
function p10k-on-pre-prompt() {
  ...
  # If there is pom.xml or gradle.build in the current directory or above,
  # show jenv. Otherwise hide it.
  if [[ -n ./(../)#(pom.xml|gradle.build)(#qN) ]]; then
